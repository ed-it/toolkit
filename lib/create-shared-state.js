...
const { rgbToXy, xyToRgb } = require('./colour-tools');
    ...
    try {
        ...
        const sharedState = {
            ...
            h: {
                ...
                sleep: (ms, caller, ...args) => {
                    return new Promise(resolve => setTimeout(caller || resolve, ms, ...args));
                },
                speak: async (text, speed = 1.0, voice = false) => {
